...
import edu.poly.reponsitory.AccountRepository;
...
public class AccountServiceImpl implements AccountService{
	...
	public Account login (String username, String password) {
		Optional<Account> usn = findById(username);
//		Optional<Account> pw = findById(password);
		
		// neu co ton tai usn, so sanh pw vs  trong csdl
		if(usn.isPresent() && bCryptPasswordEncoder.matches(password, usn.get().getPassword())) {
			usn.get().setPassword("");
			return usn.get();
		}
		return null;
